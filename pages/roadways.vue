<template>
  <div class="transition-colors duration-1000 bg-white">
    ...
    <section class="text-gray-700 mx-auto lg:w-3/4 lg:px-0 items-center pt-32">
      ...
      <div class="flex flex-col items-start px-5 py-16 mx-auto lg:items-center md:flex-row">
        ...
        <div class="flex flex-col items-start text-left lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16">
          ...
          <h1 class="mb-8 text-2xl font-bold tracking-tighter text-left text-black title-font"> A pretty long length
            display headline ready to convert visitors into users.</h1>
          <p class="mb-8 text-base leading-relaxed text-left text-gray-700">Deploy your mvp in minutes, not days. WT
            offers you a a wide selection swapable sections for your landing page.You are going to have fun building it,
            I did..</p>
      ...
      <div class="flex flex-col lg:flex-row">
        <div class="w-full mx-auto text-lg leading-snug tracking-tight text-gray-500 lg:px-0 lg:w-3/4">
          ...
          <div
            ...
            "Focus on the customer journey" </div>
